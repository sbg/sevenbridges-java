 ...
 * updated on the Seven Bridges Platform by sending the currently specified resource properties on a
 * proper endpoint for the current resource type with PUT method. Usually you should just use {@link
 * Saveable#save()} method.
 */
public interface Updatable {
   ...
   * that differs between types and instances of resources via the http PUT method.
   */
  void update();
