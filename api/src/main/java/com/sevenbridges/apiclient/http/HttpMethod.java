 ...
 */
package com.sevenbridges.apiclient.http;

/**
 * An enum representing the HTTP methods defined in the <a href="http://www.w3.org/Protocols/rfc2616/rfc2616-sec9.html">Hypertext
 * Transfer Protocol -- HTTP/1.1</a> specification.
 */
public enum HttpMethod {
   ...
   * @throws IllegalArgumentException if {@code name} is null or does not match (case insensitive)
   *                                  an HttpMethod value.
   */
