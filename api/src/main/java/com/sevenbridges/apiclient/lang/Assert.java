...
public abstract class Assert {
  ...
  /**
   * Assert that an array has elements; that is, it must not be {@code null} and must have at least
   * one element.
   * <pre>
  ...
  /**
   * Assert that a Map has entries; that is, it must not be {@code null} and must have at least one
   * entry.
   * <pre>
   ...
   * @param message   a message which will be prepended to the message produced by the function
   *                  itself, and which may be used to provide context. It should normally end in a
   *                  ": " or ". " so that the function generate message looks ok when prepended to
   *                  it.
   * @throws IllegalArgumentException if the classes are not assignable
   */
