 ...
 */
package com.sevenbridges.apiclient.lang;
...
/**
 * Utility class to create UTC-based dates and perform time conversions from UTC to other {@link
 * TimeZone timezones} and vice versa.
 */
public class Instants {

  private Instants() { /* No instance methods */ }

  public static final TimeZone UTC_TIMEZONE = TimeZone.getTimeZone("UTC");

  /**
   * Converts a given time from UTC (Coordinated Universal Time) to the corresponding time in the
   * specified {@link TimeZone}.
   *
   * @param time the UTC instant to convert, represented as the number of milliseconds that have
  ...
  /**
   * Converts a given time from the specified {@link TimeZone} to the corresponding UTC (Coordinated
   * Universal Time) time.
   *
   * @param time the instant to convert, represented as the number of milliseconds that have elapsed
   *             since midnight, January 1, 1970
   * @param from the original {@link TimeZone}
   * @return the UTC instant, represented as the number of milliseconds that have elapsed since
   ...
   *
   * @param time the instant to convert, represented as the number of milliseconds that have elapsed
   *             since midnight, January 1, 1970 in the {@code from} {@link TimeZone}
   * @param from the original {@link TimeZone}
   * @param to   the target {@link TimeZone} for the conversion
   * @return the long representation of the instant converted to the specified {@code to} {@link
   * TimeZone}
   */
   ...
   * time, sets the specified {@code year} and returns the Date converted to a UTC timestamp.
   *
  ...
  /**
   * Creates an UTC-based {@link Date} from the provided {@code year} and {@code month}. Uses the
   * current date and time, sets the specified {@code year} and {@code month}, and returns the Date
   * converted to a UTC timestamp.
   *
   * @param year  the year to represent
   ...
   * Uses the current date and time, sets the specified {@code year}, {@code month} and {@code day},
   * and returns the Date converted to a UTC timestamp.
   *
   * @param year  the year to represent
   * @param month the month-of-year to represent, from 0 (January) to 11 (December)
  ...
  /**
   * Creates an UTC-based {@link Date} from the provided {@code year}, {@code month}, {@code day}
   * and {@code hour}. Uses the current date and time, sets the specified {@code year}, {@code
   * month}, {@code day} and {@code hour}, and returns the Date converted to a UTC timestamp.
   *
   * @param year  the year to represent
   * @param month the month-of-year to represent, from 0 (January) to 11 (December)
   * @param day   the day-of-month to represent, from 1 to 31
  ...
  /**
   * Creates an UTC-based {@link Date} from the provided {@code year}, {@code month}, {@code day},
   * {@code hour} and {@code minute}. Uses the current date and time, sets the specified {@code
   * year}, {@code month}, {@code day}, {@code hour} and {@code minute}, and returns the Date
   * converted to a UTC timestamp.
   *
   * @param year   the year to represent
   * @param month  the month-of-year to represent, from 0 (January) to 11 (December)
  ...
  /**
   * Creates an UTC-based {@link Date} from the provided {@code year}, {@code month}, {@code day},
   * {@code hour}, {@code minute} and {@code second}. Uses the current date and time, sets the
   * specified {@code year}, {@code month}, {@code day}, {@code hour}, {@code minute} and {@code
   * second}, and returns the Date converted to a UTC timestamp.
   *
   * @param year   the year to represent
   * @param month  the month-of-year to represent, from 0 (January) to 11 (December)
   * @param day    the day-of-month to represent, from 1 to 31
