...
public abstract class Objects {
   ...
   * @return boolean indicator is array
   */
   ...
   * @return boolean indicator is empty
   */
   ...
   *
   * @param <A>   concrete type of array
   * @param <O>   concrete type of object to append to array
   ...
   * Object#hashCode()}}. If the object is an array, this method will delegate to any of the {@code
   * nullSafeHashCode} methods for arrays in this class. If the object is {@code null}, this method
   * returns 0.
   *
   * @param obj object to hash
   * @return hash value of obj
   ...
   *
   * @param array object to hash
   * @return hash value of array
   */
   ...
   *
   * @param bool object to hash
   * @return hash value of input param
