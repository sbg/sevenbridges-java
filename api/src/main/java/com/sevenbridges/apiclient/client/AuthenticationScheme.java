...
/**
 * Enumeration that defines the available HTTP authentication schemes to be used when communicating
 * with the Seven Bridges API server.
 * <p>
 * There is currently only one authentication scheme available: Token Authentication
 */
public enum AuthenticationScheme {

  AUTH_TOKEN("com.sevenbridges.apiclient.impl.http.authc.AuthTokenRequestAuthenticator"); //Token Authentication
