...
/**
 * HTTP proxy server communication settings, used if the Seven Bridges Java Client must communicate
...
public class Proxy {
  ...
  /**
   * Creates a instance reflecting an HTTP proxy server that <em>does not</em> require
   * authentication.
   *
  ...
  /**
   * Creates an instance reflecting an HTTP proxy server that requires username/password
   * authentication.
   *
   * @param host     the proxy server host.
   * @param port     the proxy server host port.
