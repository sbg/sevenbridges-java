...
public class DefaultResourceFactory implements ResourceFactory {
  ...
  private static final String BASE_PACKAGE = "com.sevenbridges.apiclient.";
  ...
  static <T extends Resource> Class<T> convertToInterfaceClass(Class<T> clazz) {
    ...
    //e.g. if impl is com.sevenbridges.apiclient.impl.account.DefaultAccount, 'afterBase' is impl.account.DefaultAccount
  ...
  static <T extends Resource> Class<T> convertToImplClass(Class<T> clazz) {
    ...
    String afterBase = fqcn.substring(BASE_PACKAGE.length());
    //e.g. if interface is com.sevenbridges.apiclient.account.Account, 'afterBase' is account.Account
