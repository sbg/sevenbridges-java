...
public class RequestUtils {
  ...
  private RequestUtils() { /* No instance methods */ }

  /**
   * Returns {@code true} if the specified URI uses a standard port (i.e. http == 80 or https ==
   * 443), {@code false} otherwise.
   *
   * @param uri the URI to check for standard port
