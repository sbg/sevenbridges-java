...
import com.sevenbridges.apiclient.impl.util.MultiValueMap;
...
public class HttpHeaders implements MultiValueMap<String, String> {
   ...
   * {@code contentLength} is negative, the {@code Content-Length} header will be removed (not
   * set).
   *
  ...
  /**
   * Sets the date and time at which the message was created, as specified by the {@code Date}
   * header.
   * <p>
  ...
  /**
   * Returns the date and time at which the message was created, as specified by the {@code Date}
   * header.
   * <p>
   * The date is returned as the number of milliseconds since January 1, 1970 GMT. Returns -1 when
   * the date is unknown.
   *
  ...
  /**
   * Sets the date and time at which the message is no longer valid, as specified by the {@code
   * Expires} header.
   * <p>
   * The date should be specified as the number of milliseconds since January 1, 1970 GMT.
   *
  ...
  /**
   * Returns the date and time at which the message is no longer valid, as specified by the {@code
   * Expires} header.
   * <p>
   * The date is returned as the number of milliseconds since January 1, 1970 GMT. Returns -1 when
   * the date is unknown.
  ...
  /**
   * Returns the time the resource was last changed, as specified by the {@code Last-Modified}
   * header.
   * <p>
   * The date is returned as the number of milliseconds since January 1, 1970 GMT. Returns -1 when
   * the date is unknown.
