...
public class ApiAuthenticationExceptionFactory {
  ...
  public static final String MORE_INFO = "http://docs.sevenbridges.com/docs/api-status-codes";

  private static final String DEFAULT_DEVELOPER_MESSAGE = "Authentication with a valid Authentication Token is required.";
  ...
  public static ResourceException newApiAuthenticationException(Class<? extends ResourceException> clazz) {
    ...
    Error error = DefaultErrorBuilder
        .status(AUTH_EXCEPTION_STATUS)
