...
import com.sevenbridges.apiclient.impl.util.LinkedCaseInsensitiveMap;
...
/**
 * Imported from the Spring Framework.
 */
public class MediaType implements Comparable<MediaType> {
  ...
  /**
   * Indicates whether this media type is concrete, i.e. whether neither the type or subtype is a
  ...
  /**
   * Return the quality value, as indicated by a <code>q</code> parameter, if any. Defaults to
   * <code>1.0</code>.
   *
   ...
   * <p>
   * For instance, {@code text/*} includes {@code text/plain} and {@code text/html}, and {@code
   * application/*+xml} includes {@code application/soap+xml}, etc. This method is <b>not</b>
   * symmetric.
   *
   * @param other the reference media type with which to compare
   * @return <code>true</code> if this media type includes the given media type; <code>false</code>
   * otherwise
   */
   ...
   * <p>
   * For instance, {@code text/*} is compatible with {@code text/plain}, {@code text/html}, and vice
   * versa. In effect, this method is similar to {@link #includes(MediaType)}, except that it
   * <b>is</b> symmetric.
   *
   * @param other the reference media type with which to compare
   * @return <code>true</code> if this media type is compatible with the given media type;
   ...
   * <ol>
   *   <li>
   *     if either media type has a {@linkplain #isWildcardType() wildcard type}, then the media
   *     type without the wildcard is ordered before the other.
   *   </li>
   *   <li>
   *     if the two media types have different {@linkplain #getType() types}, then they are
   *     considered equal and remain their current order.
   *   </li>
   *   <li>
   *     if either media type has a {@linkplain #isWildcardSubtype() wildcard subtype}, then the
   *     media type without the wildcard is sorted before the other.
   *   </li>
   *   <li>
   *     if the two media types have different {@linkplain #getSubtype() subtypes}, then they are
   *     considered equal and remain their current order.
   *   </li>
   *   <li>
   *     if the two media types have different {@linkplain #getQualityValue() quality value}, then
   *     the media type with the highest quality value is ordered before the other.
   *   </li>
   *   <li>
   *     if the two media types have a different amount of {@linkplain #getParameter(String)
   ...
   *   <li>
   *     if the two media types have different {@linkplain #getType() types}, then they are
   *     considered equal and remain their current order.</li> <li>if either media type has a
   *     {@linkplain #isWildcardSubtype() wildcard subtype}, then the media type without the
   *     wildcard is sorted before the other.
   *   </li>
   *   <li>
   *     if the two media types have different {@linkplain #getSubtype() subtypes}, then they are
   *     considered equal and remain their current order.
