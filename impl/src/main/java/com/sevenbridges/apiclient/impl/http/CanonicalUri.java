...
/**
 * A canonical representation of a <a href="http://tools.ietf.org/html/rfc3986">Uniform Resource
 * Identifier (URI)</a> suitable for the our needs.
 */
public interface CanonicalUri {
  ...
  /**
   * Returns the URI's canonical {@code query} representation or {@code null} if there is no query
   * component.
   *
   * @return the URI's canonical {@code query} representation or {@code null} if there is no query
   * component.
   */
