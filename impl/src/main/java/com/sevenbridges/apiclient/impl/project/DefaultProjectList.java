...
public class DefaultProjectList extends AbstractCollectionResource<Project> implements ProjectList {
  ...
  public DefaultProjectList(InternalDataStore dataStore) {
    super(dataStore);
  }

  public DefaultProjectList(InternalDataStore dataStore, Map<String, Object> properties) {
    super(dataStore, properties);
  }

  public DefaultProjectList(InternalDataStore dataStore, Map<String, Object> properties, Map<String, Object> queryParams) {
    super(dataStore, properties, queryParams);
  }

  @Override
  protected Class<Project> getItemType() {
