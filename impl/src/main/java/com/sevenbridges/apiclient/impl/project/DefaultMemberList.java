...
public class DefaultMemberList extends AbstractCollectionResource<Member> implements MemberList {
  ...
  public DefaultMemberList(InternalDataStore dataStore) {
    super(dataStore);
  }

  public DefaultMemberList(InternalDataStore dataStore, Map<String, Object> properties) {
    super(dataStore, properties);
  }

  public DefaultMemberList(InternalDataStore dataStore, Map<String, Object> properties, Map<String, Object> queryParams) {
