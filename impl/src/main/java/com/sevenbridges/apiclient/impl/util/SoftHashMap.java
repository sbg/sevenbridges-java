 ...
 * version (with their approval)</a>, with continued modifications.  It was copied from the <a
 * href="http://shiro.apache.org">Apache Shiro</a> framework.
 * <p>
...
public class SoftHashMap<K, V> implements Map<K, V> {
   ...
   * strong references.
   * <p>
   * Note that in a highly concurrent environments the exact total number of strong references may
   * differ slightly than the actual <code>retentionSize</code> value.  This number is intended to
   ...
   *                      referenced (retained), preventing them from being eagerly garbage
  ...
  private static class SoftValue<V, K> extends SoftReference<V> {
    ...
    /**
     * Constructs a new instance, wrapping the value, key, and queue, as required by the
     * superclass.
     *
